...
// MockModifiableTool class removed - modifiable-tool functionality is no longer supported
...
// Test for CoreToolScheduler with payload removed - modifiable-tool functionality is no longer supported
